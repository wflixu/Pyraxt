...
class Config:
    def __init__(self) -> None:
        parser = argparse.ArgumentParser(description="Axon, a fast async web framework with a rust runtime.")
        self.parser = parser
        parser.add_argument(
            "--processes",
            type=int,
        ...
        parser.add_argument(
            ...
            action="store_true",
            default=False,
            help="Open the Axon documentation.",
        )
        parser.add_argument(
            "--open-browser",
            action="store_true",
