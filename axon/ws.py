...
from axon.axon import FunctionInfo
...
class WebSocket:
    ...
    def __init__(self, axon_object: "Axon", endpoint: str, config: Config = Config(), dependencies: DependencyMap = DependencyMap()) -> None:
        self.axon_object = axon_object
    ...
    def on(self, type: str) -> Callable[..., None]:
        def inner(handler):
            ...
            for dependency in injected_dependencies:
                ...
                self.axon_object.add_web_socket(self.endpoint, self)
