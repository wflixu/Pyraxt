...
from axon.axon import get_version
...
def create_axon_app():
    ...
    print(f"Creating a new Axon project '{final_project_dir_path}'...")
    ...
    print(f"New Axon project created in '{final_project_dir_path}' ")


def docs():
    print("Opening Axon documentation... | Offline docs coming soon!")
    webbrowser.open("https://axon.tech")
