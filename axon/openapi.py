...
from axon.responses import html
from axon.axon import QueryParams, Response
from axon.types import Body
...
class OpenAPI:
    ...
    def get_path_obj(
        ...
        # axon has paths like /:url/:etc whereas openapi requires path like /{url}/{path}
    ...
    def get_openapi_docs_page(self) -> Response:
        ...
        """
        with resources.open_text("axon", "swagger.html") as path:
            html_file = path.read()
