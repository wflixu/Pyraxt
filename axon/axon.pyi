...
class MiddlewareType(Enum):
    """
    The middleware types supported by Axon.
...
class HttpMethod(Enum):
    """
    The HTTP methods supported by Axon.
...
class Server:
    """
    The Server object used to create a Axon server.

    This object is used to create a Axon server and add routes, middlewares, etc.
    """
