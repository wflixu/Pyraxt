...
# Benchmark script to get info about Axon's performances
# You can use this benchmark when developping on Axon to test if your changes had a huge
...
Help() {
    echo "Benchmark script to get info about Axon's performances."
    echo
    echo "USAGE:"
    ...
    echo "    -m              Run 'maturin develop' to compile the Rust part of Axon."
...
# Kill subprocesses after exiting the script (python + axon server)
