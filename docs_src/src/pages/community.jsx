    ...
    const fetchContributors = async () => {
      try {
        const response = await fetch(
          `https://api.github.com/repos/sparckles/axon/contributors`
        )
        if (!response.ok) {
  ...
  return (
    <>
      <Head>
        <meta
          name="description"
          content="The Axon Community is a group of people who are passionate about the Axon project."
        />
      </Head>
      <main className="relative isolate">
        ...
        <div className="px-6 pt-14 lg:px-8">
          <div className="mx-auto max-w-2xl pt-24 text-center sm:pt-40">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Axon is a community project and is housed under the sparckles
              orgranisation.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Axon is housed under an open source orgranisation called
