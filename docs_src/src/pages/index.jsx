...
function CodeSnippet() {
  ...
  const pythonCode = `from axon import Axon
...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>
          Axon - A Fast, Innovator Friendly, and Community Driven Python Web
          Framework.
        </title>
        <meta
          name="description"
          content="Axon - A Fast, Innovator Friendly, and Community Driven Python Web Framework."
        />
        <meta
          property="og:title"
          content="Axon - A Fast, Innovator Friendly, and Community Driven Python Web Framework."
        />
        <meta property="og:image" content="https://axon.tech/axonog.png" />
        <meta
          property="og:description"
          content="Axon is a fast, innovator-friendly, and community-driven Python web framework."
        />
        <meta property="og:url" content="https://axon.tech" />
        ...
        <meta
          ...
          content="Axon is a fast, innovator-friendly, and community-driven Python web framework."
        />
        <meta name="twitter:image" content="https://axon.tech/axonog.png" />

        {/*LinkedIn specific meta tags*/}
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="Axon Framework" />
      </Head>
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl text-center sm:max-w-4xl">
                <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">
                  Meet<span className="text-yellow-400"> Axon</span>
                </h1>
                ...
                <p className="mt-6 text-lg leading-8 text-gray-300">
                  Axon merges Python's async capabilities with a Rust runtime
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6">
                  ...
                  <a
                    href="https://github.com/sparckles/axon"
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <dl className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 text-base leading-7 text-gray-300 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:gap-x-16">
            <div className="relative pl-9">
              ...
              <dd className="inline">
                Axon, written in Rust, embodies speed and reliability. Our
            ...
            <div className="relative pl-9">
              ...
              <dd className="inline">
                With Axon, complexity takes a backseat. Our API is simple yet
            ...
            <div className="relative pl-9">
              ...
              <dd className="inline">
                ...
                never encounter, Axon prioritizes the broader issues most
                developers face. We foster innovation for all, ensuring both
                common and complex challenges are met with expertise. At Axon,
            ...
            <div className="relative pl-9">
              ...
              <dd className="inline">
                Rooted in a community-first ethos, Axon is built with
