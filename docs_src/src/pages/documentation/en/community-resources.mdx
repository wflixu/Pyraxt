export const description =
  'On this page, we`ll take a look at some community resources contributed by our amazing members to help developers get started with Axon.'
...
## Blogs
- [Hello, Axon!](https://www.sanskar.me/posts/hello-axon)
