...
Templates are a powerful feature of the Axon framework that allow you to create dynamic web pages using HTML and Python. They are a great way to add a frontend to your application without having to learn a new language or framework.

Axon supports Jinja2 templates by default but provides an easy way to add other templating engines as well.
...
Now Batman very happy that the application had come to completion. However, he was not satisfied with the current state of the application. He felt the code was all crammed in a single file and asked Axon if there was a way to split the codebase in other parts.

This is Axon introduced him to the concept of routers and views.
