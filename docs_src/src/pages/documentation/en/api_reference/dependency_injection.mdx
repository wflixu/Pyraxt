export const description =
  'On this page, we will learn about dependency injection in Axon.'


## Dependency Injection

Batman wanted to learn about dependency injection in Axon. Axon introduced him to the concept of dependency injection and how it can be used in Axon.



Axon has two types of dependency injection:
...
Application level dependency injection is used to inject dependencies into the application. These dependencies are available to all the requests.
  ...
  <Col>
    ...
    ```python {{ title: 'untyped' }}
      from axon import Axon, ALLOW_CORS
...
Router level dependency injection is used to inject dependencies into the router. These dependencies are available to all the requests of that router.
  ...
  <Col>
    ...
    ```python {{ title: 'typed' }}
      from axon import Axon, ALLOW_CORS, Request
...
Axon introduced him to the concept of exceptions and how he can use them to handle errors in his application.
