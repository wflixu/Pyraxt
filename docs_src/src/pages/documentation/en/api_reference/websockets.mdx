...
<Row>
<Col>
To handle real-time communication, Batman learned how to work with WebSockets. He created a WebSocket class and wrapped it around his Axon app:
</Col>
  <Col sticky>
    ...
    from axon import Axon, jsonify, WebSocket
...
<Row>
  <Col>
    Axon also showed Batman to work with query params.
  </Col>
  <Col sticky>
...
Axon told him about the different ways he could scale his application, and how to use views and subrouters to make his code more readable. 
