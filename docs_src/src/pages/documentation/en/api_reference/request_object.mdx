...
Axon supports capturing extra path parameters using the `*extra` syntax in route definitions. This allows you to capture any additional segments in the URL path that come after the defined route.
...
Now, Batman wanted to understand the configuration of the Axon server. He was then introduced to the concept of Axon env files.

- [Axon Env](/documentation/api_reference/axon_env)
