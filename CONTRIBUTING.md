...
First off, thank you for considering contributing to `Axon`. This guide details all the general information that one should know before contributing to the project.
...
```
git clone https://github.com/<YOUR_USER_NAME>/axon.git
```
...
```
git remote add upstream https://github.com/sparckles/axon.git
```
...
**1.** On GitHub, navigate to the main page of the repository. [Here](https://github.com/sparckles/axon.git) in this case.
