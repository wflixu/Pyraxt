...
from axon import Headers, Request, Response, Axon, WebSocket, WebSocketConnector, jsonify, serve_file, serve_html
from axon.authentication import AuthenticationHandler, BearerGetter, Identity
from axon.axon import QueryParams, Url
from axon.templating import JinjaTemplate
from axon.types import Body, JSONResponse, Method, PathParams
...
def sync_template_render():
    context = {"framework": "Axon", "templating_engine": "Jinja2"}
...
def main():
    app.set_response_header("server", "axon")
    app.serve_directory(
        route="/test_dir",
